...
![Trang đăng ký tài khoản customer](/fcj-workshopp-minhthanh/images/5-Workshop/hashop-test-cleanup/customer-account/image1.png)
...
![Email chứa mã xác thực](/fcj-workshopp-minhthanh/images/5-Workshop/hashop-test-cleanup/customer-account/image2.png)

Nhập mã OTP trên trang xác thực email để kích hoạt tài khoản customer.

![Trang xác thực email](/fcj-workshopp-minhthanh/images/5-Workshop/hashop-test-cleanup/customer-account/image3.png)

![Xác thực email thành công](/fcj-workshopp-minhthanh/images/5-Workshop/hashop-test-cleanup/customer-account/image4.png)
...
![Trang đăng nhập customer](/fcj-workshopp-minhthanh/images/5-Workshop/hashop-test-cleanup/customer-account/image5.png)
...
![Trang hồ sơ customer](/fcj-workshopp-minhthanh/images/5-Workshop/hashop-test-cleanup/customer-account/image6.png)

Cập nhật thông tin cá nhân, thêm địa chỉ giao hàng và liên kết MoMo làm phương thức thanh toán.

![Chỉnh sửa hồ sơ và thêm phương thức thanh toán](/fcj-workshopp-minhthanh/images/5-Workshop/hashop-test-cleanup/customer-account/image7.png)
